...
#! NOTE : A function is an instance of the Object type.
...
# or that returns a new function or both. 
...
#* 3: You can return them from other functions as values.
...
#* 4: You can store them in data structures
